...
const light_base = {
  ...
  menuIcon: "text-blue-600 mr-3 text-xl group-hover:text-white",
  topMenuBorder: "border-b border-gray-200",
  topMenuScroll: "",
  headerShadow: "",
  navText: "text-gray-100",
  navitemTop:
    "px-4 text-sm font-medium tracking-widest uppercase inline-flex items-center border-b-2 border-r border-transparent  leading-5 text-gray-600 hover:bg-white hover:text-blue-500 border-gray-200 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out h-full",
  navitemTopActive:
    "px-4 text-sm font-medium tracking-widest uppercase inline-flex items-center  border-b-2 border-r-0 leading-5 text-blue-500 bg-white focus:outline-none  sfocus:border-indigo-700 transition duration-150 ease-in-out",
  topNavHeight: "h-12",
  ...
  navitemSide: ` 
        group font-sans 
        flex mx-6 pr-4 py-2 text-base font-light hover:pl-4 text-gray-600 border-gray-200 
  ...
  navitemSideActive: `
        ...
        hover:bg-blue-600 hover:text-white 
        focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300
        border-r-4 border-blue-600 hover:border-blue-200
        transition-all cursor-pointer`,
